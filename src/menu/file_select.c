...
void print_main_menu_strings(void) {
    ...
    gDPSetEnvColor(gDisplayListHead++, 255, 255, 255, gDialogTextAlpha);
    char text[34];
    sprintf(text, "%s A", username);
    print_menu_generic_string(92, 65, text);
    sprintf(text, "%s B", username);
    print_menu_generic_string(207, 65, text);
    sprintf(text, "%s C", username);
    print_menu_generic_string(92, 105, text);
    sprintf(text, "%s D", username);
    print_menu_generic_string(207, 105, text);
...
void print_score_menu_strings(void) {
    ...
    char text[34];
    sprintf(text, "%s A", username);
    print_menu_generic_string(89, 62, text);
    sprintf(text, "%s B", username);
    print_menu_generic_string(211, 62, text);
    sprintf(text, "%s C", username);
    print_menu_generic_string(89, 105, text);
    sprintf(text, "%s D", username);
    print_menu_generic_string(211, 105, text);
    gSPDisplayList(gDisplayListHead++, dl_menu_ia8_text_end);
}
