...
const char *credits01[] = { "1HACK CREATOR", "HTAUK" };
const char *credits02[] = { "2PLAYERMODEL ASSISTANT", "ANOLIAH", "" };
const char *credits03[] = { "2EMOTIONAL SUPPORT", "WEEBO", "" };
const char *credits04[] = { "3BASE REPO", "HACKERSM64", "", "" };
...
const char *credits05[] = { "4SIMPLEFLIPS", "SIMPLEFLIPS", "SIMPLEFLIPS", "SIMPLEFLIPS GODDARD" };
